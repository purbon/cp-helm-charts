...
The [Confluent Platform Helm charts](https://github.com/purbon/cp-helm-charts) enable you to deploy Confluent Platform services on Kubernetes for development, test, and proof of concept environments.

## Installing Charts

```
helm repo add confluentinc https://purbon.github.io/cp-helm-charts/
helm repo update
```
